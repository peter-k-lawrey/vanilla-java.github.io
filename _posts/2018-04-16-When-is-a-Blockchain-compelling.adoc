...
NOTE: A high percentage of hacks involve disgruntled former employees. If you trust every noded from every provider you have to trust every person operating it.
